...
async function listing_main(data,apiKey) {
  // console.log(data);
    ...
    try {
        const cookiePath = path.join(__dirname, 'auth', `${apiKey}.json`);
    ...
    for(let i = 0; number_of_lines>i; i++){
        ...
        let price = await lines.locator('.cw5trde.atm_c8_k@m0zk7.atm_g3_18khvle.atm_fr_1m9t47k.atm_cs_6adqpa.atm_7l_jt7fhx.atm_40_4u5rid.atm_l8_8tjzot.atm_j3_kzqwjq.atm_lk_idpfg4_13mkcot.armbts6.atm_r3_1e5hqsa.dir.dir-ltr').nth(8).textContent();
